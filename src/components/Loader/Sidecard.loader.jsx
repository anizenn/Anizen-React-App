...
function SidecardLoader({
  className
}) {
  return <div className={`flex flex-col space-y-6 ${className}`}>
            <Skeleton className='w-[200px] h-[15px]' />
            <div className='flex flex-col space-y-4 bg-[#33353c] p-4 pt-8 w-full'>
                {[...Array(10)].map((_, index) => <div key={index} className='flex items-center gap-x-4'>
