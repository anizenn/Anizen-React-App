...
function AnimeInfoLoader() {
  return <>
            <div className="relative grid grid-cols-[minmax(0,75%),minmax(0,25%)] h-fit w-full overflow-hidden max-[1200px]:flex max-[1200px]:flex-col">
                <Skeleton className="absolute inset-0 w-full h-full blur-lg z-[-900] bg-gray-500" animation={false} />
                <div className="flex items-start z-10 px-14 py-[70px] bg-[#2a2c31] bg-opacity-70 gap-x-8 max-[1024px]:px-6 max-[1024px]:py-10 max-[1024px]:gap-x-4 max-[575px]:flex-col max-[575px]:items-center max-[575px]:justify-center">
                ...
                <div className="bg-[#2a2c31] flex items-center px-8 max-[1200px]:py-10 max-[1200px]:bg-[#2a2c31] max-[575px]:p-4">
