...
function VoiceActorlistLoader() {
  return <div className="w-full h-fit grid grid-cols-2 gap-4 overflow-y-hidden max-sm:gap-2 max-md:h-[400px] max-md:flex max-md:flex-col">
            {[...Array(10)].map((_, index) => <div key={index} className="h-[80px] p-4 rounded-md bg-[#2a2c31]">
